...
void named_goal::display(int ind) const {
    gl->display(ind);
}

void named_goal::write(ostream &o) const {
    gl->write(o);
}

void named_goal::visit(VisitController *v) const {
    gl->visit(v);
}
...
void class_def::visit(VisitController *v) const {
    v->visit_class_def(this);
};
